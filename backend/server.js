...
// Route spéciale pour les liens de partage avec métadonnées Open Graph pour les bots
app.get('/share/:token', async (req, res) => {
  try {
    ...
    console.log('🔍 [DEBUG Share Route] Token:', token);
    console.log('🔍 [DEBUG Share Route] User-Agent:', userAgent);
    console.log('🔍 [DEBUG Share Route] Is Bot:', isBot);
    ...
    console.log('🔍 [DEBUG Share Route] Métadonnées pour bot:', {
      title,
      description,
      imageUrl,
